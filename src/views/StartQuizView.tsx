    ...
    return (
        <div className='flex items-center justify-center h-screen gap-5'>
            ...
            <div className='flex flex-col items-center gap-5 scale-125'>
                <h1 className='text-[32px] text-white'>Start <span className='text-blue-500'>Quiz</span></h1>
                <h3 className="text-white">Welcom to <span className='text-blue-500'>Expertizo </span>Quiz, Click on the button below to start you quiz.</h3>
